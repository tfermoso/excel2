        ...
        if (in_array($ext, $allowedExtensions)) {
            ...
            if ($file_size < 50) {
                ...
                if ($isUploaded) {
                    ...
                    $select = '<select class="col_lumna" id="column" name="column">
                    ...
                    for ($row = 2; $row <= 3; $row++) {
                        ...
                        foreach ($single_row[0] as $key => $value) {
                            if ($key == 6) {
                                ...
                                echo "<td>" . $fecha_php . " -" . $key . "</td>";
                                $query .= "'" . mysqli_real_escape_string($con, $fecha_php) . "',";
                            } else {
                    ...
                    $query = substr($query, 0, -1);
                    echo '</table>';
                    echo '<br><button id="btnEnviar" disabled>Cargar datos</button><br>';
                    // echo $query;
